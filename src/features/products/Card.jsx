    ...
    <div className="bg-white rounded-lg sm:rounded-xl md:rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 w-full overflow-hidden flex flex-col group h-full">
      {successMsg && (
        <Alert
          ...
          severity="success"
          className="mb-1.5 mx-2 sm:mx-3 md:mx-4 mt-2 sm:mt-3 text-xs sm:text-sm"
        >
          {successMsg}
        </Alert>
      )}
      <div className="relative bg-gray-100 w-full aspect-square sm:aspect-[4/5] md:aspect-[3/4] overflow-hidden">
        <img
          src={imageCover.url}
          alt={name}
      ...
      <div className="p-2.5 sm:p-3 md:p-4 flex flex-col flex-grow">
        <div className="flex-grow">
          ...
          {availableSizes.length > 0 && (
            <div className="mb-1.5 sm:mb-2">
              <span className="font-semibold text-gray-700 text-[10px] sm:text-xs md:text-sm mb-1 block">Size:</span>
        ...
        <div className="mt-auto pt-1.5 sm:pt-2 border-t border-gray-100">
          ...
          <div className="text-center">
            <span className={`text-[10px] sm:text-xs md:text-sm font-medium ${inStock ? "text-green-600" : "text-red-600"}`}>
